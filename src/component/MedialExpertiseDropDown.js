...
export default function MedialExpertiseDropDown(props) {
  ...
  useEffect(() => {
    setList([]);
    setList(props.selectedMedicalExpList);
    setUpdateSelectedList(!updateSelectedList);
  }, [props.selectedMedicalExpList]);
  ...
  const toggleOpen = () => {
    if (itemList.length > 0) {
      ...
      snackbarError('Carer do not have any medical expertise');
    }
  };
  return (
    <>
