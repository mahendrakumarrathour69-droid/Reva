...
export default function LangauageMultiple(props) {
  ...
  useEffect(() => {
    setList([]);
    setList(props.selectedLangaugeList);
    setUpdateSelectedList(!updateSelectedList);
  }, [props.selectedLangaugeList]);
  //   useEffect(() => {
  //     setList([]);
              ...
              <View
                ...
                <View
                  ...
                  <TouchableOpacity onPress={() =>
                    ...
                    editable == false ? snackbarError("Can’t change") : listDelete(index, rowData)
                  }
                  >
                    <Image
                      source={images.cross}
